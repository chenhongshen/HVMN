...
def prototype_ubuntu_HRED():
    ...
    state['train_dialogues'] = "/export/sdb/home/chenhongshen/MVHRED/data/UbuntuData/Training.dialogues.pkl"
    state['test_dialogues'] = "/export/sdb/home/chenhongshen/MVHRED/data/UbuntuData/Test.dialogues.pkl"
    state['valid_dialogues'] = "/export/sdb/home/chenhongshen/MVHRED/data/UbuntuData/Validation.dialogues.pkl"
    state['dictionary'] = "/export/sdb/home/chenhongshen/MVHRED/data/UbuntuData/Dataset.dict.pkl"
    state['save_dir'] = "Output"
...
def prototype_jd_LSTM():
    ...
    state['train_dialogues'] = "/export/sdb/home/chenhongshen/MVHRED/data/JD/new/Training.dialogues.pkl"
    state['test_dialogues'] = "/export/sdb/home/chenhongshen/MVHRED/data/JD/new/Test.dialogues.pkl"
    state['valid_dialogues'] = "/export/sdb/home/chenhongshen/MVHRED/data/JD/new/Validation.dialogues.pkl"
    state['dictionary'] = "/export/sdb/home/chenhongshen/MVHRED/data/JD/new/Training.dict.pkl"
    state['save_dir'] = "Output"
...
# Ubuntu VHRED model used in "A Hierarchical Latent Variable Encoder-Decoder Model for Generating Dialogues"
# by Serban et al. (2016). Note, this model was pretrained as the HRED model with state 'prototype_jd_HRED'!
def prototype_jd_VHRED():
    state = prototype_state()
...
def prototype_jd_MVHRED():
    ...
    # Memory
    state['add_memory'] = True
    state['memory_size'] = 10
    state['memory_dim'] = 100
