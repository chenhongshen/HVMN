...
def greedy_score(fileone, filetwo, w2v):
    ...
    r1 = f1.readlines()
    r2 = f2.readlines()
    dim = 50 #w2v.layer1_size # embedding dimensions
...
def average(fileone, filetwo, w2v):
    ...
    r1 = f1.readlines()
    r2 = f2.readlines()
    dim = 50 #w2v.layer1_size # dimension of embeddings
...
if __name__ == "__main__":
    ...
    print "loading embeddings file...",args.embeddings
